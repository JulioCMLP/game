...
function ganar(opcionUser, opcionPc){
  ...
  result_div.innerHTML= convertirLetra(opcionUser)+smallUser+" beats "+convertirLetra(opcionPc)+smallPc+".<br> You win!!";
...
function pierda(opcionUser, opcionPc){
  ...
  const smallUser= "(USER)".fontsize(2);
  const smallPc= "(PC)".fontsize(2);
  result_div.innerHTML= convertirLetra(opcionPc)+smallPc+" beats "+convertirLetra(opcionUser)+smallUser+".<br> You lose";
  const userChoice_div= document.getElementById(opcionUser);
  const pcChoice_div= document.getElementById(opcionPc);
...
function empate(opcionUser){
  result_div.innerHTML= "Both choose "+convertirLetra(opcionUser)+".<br> It's a tie!!";
